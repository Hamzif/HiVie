...
user_2 = User.create(email: 'byebyeangelina@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Brad', last_name: 'Pitt', username: 'Bogoss94XXX',  city: 'Barcelona', birthday: '25/06/1975'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 5, diagnosis_year: 2004, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631794/user_profile_images/T02NE0241-UPL4NQ8DS-2b931133ac94-512_c7a661.jpg')
...
user_3 = User.create(email: 'becca@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Rebecca', last_name: 'Jones', username: 'Becks',  city: 'Barcelona', birthday: '17/03/1997'.to_date, gender: 'Female', sex_pref: 'Male', distance_pref: 8, diagnosis_year: 2016, remote_photo_url: 'https://kitt.lewagon.com/placeholder/users/humbeline',
 bio: 'Grew up in the Portland, Oregon area. Survived middle school by becoming a skater kid (still haven’t grown out of it). Now I’m trying to pay my rent, play my music, and make my way.')
...
# MALE
user_6 = User.create(email: 'jack@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Jack', last_name: 'Titanic', username: 'Iloverose',  city: 'Barcelona', birthday: '18/09/1979'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2005, remote_photo_url:'https://www.pexels.com/photo/man-person-portrait-autumn-16622/')
...
# FEMALE
user_8 = User.create(email: 'dan@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Dan', last_name: 'Smith', username: 'DanTheMan',  city: 'Barcelona', birthday: '17/03/1987'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 8, diagnosis_year: 2018, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575630984/user_profile_images/T02NE0241-UPLK9PZ2R-381c9c64d4d1-512_vx01ze.jpg')
...
# MALE
user_12 = User.create(email: 'haggus@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Angus', last_name: 'Scotland', username: 'HaggusLover',  city: 'Barcelona', birthday: '06/02/1999'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 6, diagnosis_year: 2009, remote_photo_url:'https://avatars3.githubusercontent.com/u/40790744?s=400&v=4')
...
# FEMALE
user_16 = User.create(email: 'ivana@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Ivana', last_name: 'Salhi', username: 'Iva',  city: 'Barcelona', birthday: '12/05/1989'.to_date, gender: 'Female', sex_pref: 'Male', distance_pref: 15, diagnosis_year: 2018, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631636/user_profile_images/T02NE0241-UPNSBGT0W-c173a85e1293-512_jmfmsw.jpg')
...
# FEMALE
user_18 = User.create(email: 'kylie@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Kylie', last_name: 'Jenner', username: 'CallMeKylie',  city: 'Barcelona', birthday: '24/12/1998'.to_date, gender: 'Female', sex_pref: 'Male', distance_pref: 8, diagnosis_year: 2014, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631683/user_profile_images/T02NE0241-U4598RZGF-b92abaa9d3bf-512_osyidq.jpg')
...
# FEMALE
user_19 = User.create(email: 'aaliyah@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Aaliyah', last_name: 'Rodriguez', username: 'ArtsyAaliyah',  city: 'Barcelona', birthday: '17/11/1988'.to_date, gender: 'Female', sex_pref: 'Male', distance_pref: 7, diagnosis_year: 2019, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632348/user_profile_images/T02NE0241-U281EAB8D-6bd41d7b2018-512_lugths.png')
...
# MALE
user_20 = User.create(email: 'dave@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'David', last_name: 'Gyan', username: 'Dave84',  city: 'Barcelona', birthday: '12/09/1984'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 7, diagnosis_year: 2015, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632608/user_profile_images/T02NE0241-UP7T3D858-a61e60b3df53-512_qiihnf.jpg')
...
# MALE
user_21 = User.create(email: 'mo@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Mohamed', last_name: 'Junaid', username: 'Momo',  city: 'Barcelona', birthday: '14/12/1988'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 20, diagnosis_year: 2009, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632684/user_profile_images/T02NE0241-UKPKXKN3V-63e484c7b1df-512_hke0lb.jpg')
...
# MALE
user_22 = User.create(email: 'danny@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Dan', last_name: 'Tico', username: 'Dannydu38',  city: 'Barcelona', birthday: '25/07/1985'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 8, diagnosis_year: 2004, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632956/user_profile_images/T02NE0241-UPNNQ4SQ7-7a67b587c825-512_i1goyi.png')
...
# MALE
user_23 = User.create(email: 'schichokshi@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Shiv', last_name: 'Chokshi', username: 'Schichokshi',  city: 'Barcelona', birthday: '17/03/1992'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 8, diagnosis_year: 2013, remote_photo_url: 'https://res.cloudinary.com/kl3000/image/upload/v1575633440/user_profile_images/T02NE0241-UP9P145FU-5c9d7959b92f-512_dkkh5s.jpg')
...
# MALE
user_24 = User.create(email: 'jaki@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Jacki', last_name: 'Michel', username: 'MerciJacki&Michel',  city: 'Barcelona', birthday: '21/02/1993'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 7, diagnosis_year: 1990, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575633856/user_profile_images/T02NE0241-UL37H2W9L-a2b642e6c3d4-512_htrphc.jpg')
...
# FEMALE
user_26 = User.create(email: 'solange@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Solange', last_name: 'Knowles', username: 'Ihatemysister',  city: 'Barcelona', birthday: '17/08/1987'.to_date, gender: 'Female', sex_pref: 'Male', distance_pref: 7, diagnosis_year: 2012, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632170/user_profile_images/T02NE0241-UPLK2131N-e1b9f6081978-512_bcsftl.png')
