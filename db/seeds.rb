...
# MALE
user_2 = User.create(email: 'ed@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Brad', last_name: 'Pitt', username: 'BCNLover',  city: 'Barcelona', birthday: '25/06/1995'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2004, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631794/user_profile_images/T02NE0241-UPL4NQ8DS-2b931133ac94-512_c7a661.jpg', bio: 'I work in business management and I’m afraid I’m becoming a very boring single man. I’m looking for a nice partner to help me mix it up.')
puts "created user_2"

# MALE
user_11 = User.create(email: 'alex@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Alexandru', last_name: 'Sima', username: 'Alx',  city: 'Barcelona', birthday: '28/09/1998'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2018, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575630972/user_profile_images/T02NE0241-UP7UZUUTC-285ae1d2dce5-512_o0pvwi.jpg', bio: "I wear my heart on my sleeve, so what you see is what you get. I laugh and smile a lot, and love someone who can make me do just that.")
puts "created user_11"

# MALE
user_12 = User.create(email: 'angus@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Angus', last_name: 'Scotland', username: 'HaggusLover',  city: 'Barcelona', birthday: '06/02/1997'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2009, remote_photo_url:'https://avatars3.githubusercontent.com/u/40790744?s=400&v=4', bio: "I love to travel and there are still so many places in the world yet to explore. My family and friends are really important to me and I spent lots of time with them.")
puts "created user_12"

# MALE
user_15 = User.create(email: 'ben@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Ben', last_name: 'Carter', username: 'BennyBoy',  city: 'Barcelona', birthday: '11/06/1987'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2012, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631481/user_profile_images/T02NE0241-UPL897MJ8-e50ac5a48da9-512_iop3oz.png', bio: "New to dating and dating apps. Nervous to be sharing my HIV+ status publicly. Hope to find support and love.")
puts "created user_15"

# MALE
user_13 = User.create(email: 'gus@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Gus', last_name: 'Lee', username: 'CoderGus',  city: 'Barcelona', birthday: '11/09/1990'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 11, diagnosis_year: 2001, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631375/user_profile_images/T02NE0241-UPL535Y6Q-cc4875c7306c-512_ht297e.jpg', bio: "I’m friendly and a little quiet, but happy, looking for someone to spend time with, both out in town and in at home.")
puts "created user_13"

# MALE
user_20 = User.create(email: 'dave@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Dave', last_name: 'Gyan', username: 'Dave84',  city: 'Barcelona', birthday: '12/09/1989'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2015, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632608/user_profile_images/T02NE0241-UP7T3D858-a61e60b3df53-512_qiihnf.jpg', bio: "Friends or The Office? Tacos or Burrito? Music or Podcast? Dogs or Cats?")
puts "created user_20"

# MALE
user_1 = User.create(email: 'hamza@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Hamza', last_name: 'Ben Mbarek', username: 'Hamzification',  city: 'Barcelona', birthday: '08/04/1994'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2017, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631890/user_profile_images/T02NE0241-UPNR72TP0-ae9ed4ff472c-512_lfwhae.jpg', bio: 'I haven’t dated much in recent years because I’ve been so focused on my career. Now I’m ready to meet the person who will pull my head out of the books and bring me a bit of happiness.')
puts "created user_1"
...
# MALE
user_22 = User.create(email: 'isaac@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Isaac', last_name: 'Tico', username: 'ImTheOne4You',  city: 'Barcelona', birthday: '25/07/1989'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2004, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632956/user_profile_images/T02NE0241-UPNNQ4SQ7-7a67b587c825-512_i1goyi.png', bio: "Your personal guide to Barcelona. Can also teach you Spanish. Let\'s connect over coffee or beers.")
puts "created user_22"

# MALE
user_23 = User.create(email: 'kevin@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Kevin', last_name: 'Johnson', username: 'KingKev',  city: 'Barcelona', birthday: '17/03/1992'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2013, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575633440/user_profile_images/T02NE0241-UP9P145FU-5c9d7959b92f-512_dkkh5s.jpg', bio: "I\'m a grad student. Funny and charming. If you\'re open minded we\'ll get along.")
puts "created user_23"

# MALE
user_24 = User.create(email: 'martin@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Martin', last_name: 'Potie', username: 'GoodGuy',  city: 'Barcelona', birthday: '21/02/1993'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 1990, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575633856/user_profile_images/T02NE0241-UL37H2W9L-a2b642e6c3d4-512_htrphc.jpg', bio: "New to HiVie. Thankful for some anonymity. Slow to open up but excited to meet new people and maybe find love.")
puts "created user_24"

# MALE
user_25 = User.create(email: 'pablo@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Pablo', last_name: 'Line', username: 'LatinLover',  city: 'Barcelona', birthday: '13/10/1990'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2018, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575632434/user_profile_images/T02NE0241-UPE7M99U1-32151dfec812-512_xfqpoh.jpg', bio: "Travel is my passion. I write for a Travel Magazine. Where would you like to go on our first vacation?")
puts "created user_25"

# MALE
user_6 = User.create(email: 'miguel@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Miguel', last_name: 'Rubio', username: 'M.Rubio',  city: 'Barcelona', birthday: '18/09/1994'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2005, remote_photo_url:'https://www.pexels.com/photo/man-person-portrait-autumn-16622/', bio: "I\'m Young, but I know what I want. To find love with someone who can relate to my experience. Love is possible HIV+")
puts "created user_6"

# MALE
user_7 = User.create(email: 'christos@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Cristiano', last_name: 'Ronaldo', username: 'Baller85',  city: 'Barcelona', birthday: '17/08/1985'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 9, diagnosis_year: 2013, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575631375/user_profile_images/T02NE0241-UPL535Y6Q-cc4875c7306c-512_ht297e.jpg', bio: "I could spend my whole life talking about the movies and books. If you agree swipe right!")
puts "created user_7"

# MALE
user_3 = User.create(email: 'gijs@gmail.com', password: "password", min_age: 18, max_age: 50, first_name: 'Gijs', last_name: 'Maks', username: 'GMak',  city: 'Barcelona', birthday: '17/03/1997'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2016, remote_photo_url: 'https://kitt.lewagon.com/placeholder/users/humbeline', bio: 'Grew up in the United States. Moved to Barcelona 5 years ago. Living with HIV for a few years and looking for a community of support and maybe even find love.')
puts "created user_3"
...
match_6 = Match.create(user_two_id: user_1.id, user_one_id: user_16.id, status: 'initiated')
match_7 = Match.create(user_two_id: user_1.id, user_one_id: user_17.id, status: 'initiated')
match_8 = Match.create(user_two_id: user_1.id, user_one_id: user_18.id, status: 'initiated')
match_9 = Match.create(user_two_id: user_1.id, user_one_id: user_19.id, status: 'initiated')
match_10 = Match.create(user_two_id: user_1.id, user_one_id: user_26.id, status: 'initiated')

match_11 = Match.create(user_one_id: user_1.id, user_two_id: user_15.id, status: "initiated")
