...
characteristic_4 = Characteristic.create(category: 'Lifestyle', name: 'Dancer')
characteristic_5 = Characteristic.create(category: 'Lifestyle', name: 'Singer')
characteristic_6 = Characteristic.create(category: 'Lifestyle', name: 'Tech')

puts "lifestyle seeds created"

characteristic_7 = Characteristic.create(category: 'Music', name: 'Hip-hop')
characteristic_8 = Characteristic.create(category: 'Music', name: 'Jazz')
characteristic_9 = Characteristic.create(category: 'Music', name: 'Blues')
characteristic_9 = Characteristic.create(category: 'Music', name: 'Funk')
characteristic_10 = Characteristic.create(category: 'Music', name: 'Pop')
characteristic_11 = Characteristic.create(category: 'Music', name: 'Latin')

puts "music seeds created"

characteristic_12 = Characteristic.create(category: 'Personality', name: 'Cheerful')
characteristic_13 = Characteristic.create(category: 'Personality', name: 'Calm')
characteristic_14 = Characteristic.create(category: 'Personality', name: 'Caring')
characteristic_15 = Characteristic.create(category: 'Personality', name: 'Honest')
characteristic_16 = Characteristic.create(category: 'Personality', name: 'Funny')
characteristic_17 = Characteristic.create(category: 'Personality', name: 'Relaxed')
characteristic_18 = Characteristic.create(category: 'Personality', name: 'Friendly')

puts "personality seeds created"

characteristic_19 = Characteristic.create(category: 'Sports', name: 'Football')
characteristic_20 = Characteristic.create(category: 'Sports', name: 'Swimming')
characteristic_21 = Characteristic.create(category: 'Sports', name: 'Golf')
characteristic_22 = Characteristic.create(category: 'Sports', name: 'Hiking')
characteristic_23 = Characteristic.create(category: 'Sports', name: 'Yoga')
characteristic_24 = Characteristic.create(category: 'Sports', name: 'Skiing')
...
user_6 = User.create(email: 'jack@gmail.com', password: "password", first_name: 'Jack', last_name: 'Titanic', username: 'Iloverose',  city: 'Barcelona', birthday: '18/09/1979'.to_date, gender: 'Male', sex_pref: 'Female', distance_pref: 10, diagnosis_year: 2005, remote_photo_url:'https://res.cloudinary.com/kl3000/image/upload/v1575630948/user_profile_images/T02NE0241-UPM08BB4G-e03b376ab89c-512_ud9mzo.jpg')
